view: com_report_dwelltime_by_group_monthly {
 derived_table: {
  sql: select
...
#     }
    link: {
      ...
      url: "/dashboards/115?Site={{ siteName_hidden._value | url_encode}}&Group={{ parkingGroupId_hidden._value | url_encode}}&Time={{ startTime_month._value | url_encode }}&Statistics={{_filters['com_report_dwelltime_by_group_monthly.Statistics']}}"
    }
  }
