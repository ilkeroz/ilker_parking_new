...
#     sql:${objectid};;
    link: {
      ...
      url: "/dashboards/162?Site={{ sitename_hidden._value | url_encode}}&Group={{ parkinggroupname_hidden._value | url_encode}}&Time={{endTime_minute15._value | url_encode }}:00+for+1+hour&Duration={{_filters['com_turnover_with_threshold_by_group_micro.duration'] }}"
    }
  }
