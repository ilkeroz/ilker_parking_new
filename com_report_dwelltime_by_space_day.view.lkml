view: com_report_dwelltime_by_space_day {
  derived_table: {
    sql: select
  ...
  measure: DwellTime {
    ...
    value_format: "0.00"
    sql: CASE WHEN {% condition Statistics %} 'Average' {% endcondition %} THEN ${com_report_dwelltime_by_space_day.Avg_Spot_Dwelltime}
    ...
    link: {
      ...
      url: "/dashboards/54?Site={{ siteName_hidden._value | url_encode}}&Group={{ parkingGroupId_hidden._value | url_encode}}&Space={{ parkingSpotId_hidden._value | url_encode}}&Time={{ startTime_date._value | url_encode }}&Statistics={{_filters['com_report_dwelltime_by_space_day.Statistics']}}"
    }
  }
