view: com_report_dwelltime_by_group_yearly {
  derived_table: {
    sql: select
  ...
  measure: DwellTime {
    ...
    value_format: "0.00"
    sql: CASE WHEN {% condition Statistics %} 'Average' {% endcondition %} THEN ${com_report_dwelltime_by_group_yearly.Avg_Group_Dwelltime}
...
#     }
    link: {
      ...
      url: "/dashboards/114?Site={{ siteName_hidden._value | url_encode}}&Group={{ parkingGroupId_hidden._value | url_encode}}&Time={{ startTime_year._value | url_encode }}&Statistics={{_filters['com_report_dwelltime_by_group_yearly.Statistics']}}"
    }
  }
