...
#   sql:${violation};;
  link: {
    ...
    url: "/dashboards/90?Group={{ parkinggroupname_hidden._value | url_encode}}&Site={{sitename_hidden._value | url_encode }}&Violation={{violation_hidden._value | url_encode}}&Time={{endTime_time._value | url_encode}}+for+1+hour"
  }

  link: {
    label: "See Spots Violations count on 15min interval"
    url: "/dashboards/168?Group={{ parkinggroupname_hidden._value | url_encode}}&Site={{sitename_hidden._value | url_encode }}&Violation={{violation_hidden._value | url_encode}}&Time={{endTime_time._value | url_encode }}+for+1+hour"
  }
